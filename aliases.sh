...
alias cmariadb='docker compose exec -it maria_pizzeria bash'
alias db-export='docker compose exec maria_pizzeria /docker-entrypoint-initdb.d/backup.sh'
alias db-import='docker compose exec maria_pizzeria /docker-entrypoint-initdb.d/restore.sh'
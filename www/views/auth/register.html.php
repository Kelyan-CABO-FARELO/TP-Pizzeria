        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <form class="p-6 space-y-6" action="/register" method="post">
                ...
                <div class="text-center pt-4 border-t border-gray-200">
                    <p class="text-sm text-gray-600">Vous avez déjâ un compte ?<a class="font-semibold text-indigo-600 hover:text-indigo-700 transition-colors" href="/auth/login"> Connectez-vous !</a></p>
                </div>
            </form>
        </div>
    </div>

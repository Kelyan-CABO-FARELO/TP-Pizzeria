                ...
                <?php foreach ($pizzas as $pizza): ?>
                    <div class="bg-white rounded-lg shadow-md overflow-hidden transform hover:-translate-y-1 hover:shadow-xl transition duration-300 flex flex-col h-full">
                        ...
                        <div class="p-4 flex flex-col flex-grow">
                            ...
                            <a href="/onepizza/<?= $pizza->id ?>" class="w-full bg-gray-900 hover:bg-gray-800 text-white text-xs font-bold py-2 px-4 rounded transition duration-200 flex items-center justify-center gap-2">
                                Commander
